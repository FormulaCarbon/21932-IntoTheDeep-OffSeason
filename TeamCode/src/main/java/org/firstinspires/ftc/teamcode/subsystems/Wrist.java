...
public class Wrist {
    ...
    public static double autoPos = 0.63, intakepos = 0, bBasket = 0.88, fBasket = 0.61, bIdle = 0.85, fIdle = 0.1356, bIntake = 0.87, fIntake = 0.0, fDrop = 0.4;
    public static double bStart = 0.74, fStart = 1;
