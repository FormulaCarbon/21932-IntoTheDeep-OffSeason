...
public class MecanumDrive {
    public static class Params {
        ...
        public double lateralInPerTick = 0.5468404133065315; // Tune this with LateralRampLogger (even if you use OTOS/Pinpoint)
        public double trackWidthTicks = 10.409138009415814;

        // feedforward parameters (in tick units)
        public double kS = 1.8295082332433945;
        public double kV = 0.00030497234381019251;
