...
public final class PinpointLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = 98441.44810484475; // y position of the parallel encoder (in tick units)
        public double perpXTicks = -154602.32698196027; // x position of the perpendicular encoder (in tick units)
    }
